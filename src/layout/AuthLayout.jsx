        ...
        <div className="relative px-10">
          ...
          <ul className="mt-8 space-y-5">
            ...
            <li className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-white">Always Answered, Clearly Sourced</p>
                <p className="text-xs leading-relaxed text-white/70">Claims from your documents are cited by source chunk; anything filled in from general knowledge is clearly marked as such.</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <span className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-white/10 text-white">
